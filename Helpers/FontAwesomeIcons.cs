namespace Explosion.Helpers;
/// <summary>
/// Classe générée avec https://andreinitescu.github.io/IconFont2Code puis adaptée
/// En suivant la doc de https://cedricgabrang.medium.com/custom-fonts-material-design-icons-in-net-maui-acf59c9f98fe
/// Et en récupérant la font de https://fontawesome.com/download ou https://github.com/FortAwesome/font-awesome-sass/blob/master/assets/fonts/font-awesome/fa-solid-900.ttf
/// </summary>
public static class FontAwesomeIcons
{
    ...
    public const string LetterB = "\u0042";
    public const string LetterC = "\u0043";
    public const string LetterD = "\u0044";
    public const string LetterE = "\u0045";
    public const string LetterF = "\u0046";
    public const string LetterG = "\u0047";
    public const string LetterH = "\u0048";
    public const string LetterI = "\u0049";
    public const string LetterJ = "\u004a";
    ...
    public const string LetterQ = "\u0051";
    public const string LetterR = "\u0052";
    public const string LetterS = "\u0053";
    public const string LetterT = "\u0054";
    public const string LetterU = "\u0055";
    public const string LetterV = "\u0056";
    public const string LetterW = "\u0057";
    public const string LetterX = "\u0058";
    public const string LetterY = "\u0059";
    public const string LetterZ = "\u005a";
